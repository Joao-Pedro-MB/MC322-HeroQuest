...
public class RandomMap {
	...
	public void generateRandomMap() {
		...
		mapa.includeWall(1, 0, "lado");
		mapa.includeWall(2, 0, "lado");
		mapa.includeWall(3, 0, "lado");
		mapa.includeWall(4, 0, "lado");
		mapa.includeWall(5, 0, "lado");
		mapa.includeWall(6, 0, "lado");
		...
		mapa.includeWall(2, 4, "lado");
		mapa.includeWall(3, 4, "baixolado");
		mapa.includeWall(4, 4, "lado");
		mapa.includeWall(5, 4, "lado");
		mapa.includeWall(6, 4, "lado");
		mapa.includeWall(7, 4, "lado");
		...
		mapa.includeWall(2, 8, "lado");
		mapa.includeWall(3, 8, "baixolado");
		mapa.includeWall(4, 8, "lado");
		mapa.includeWall(5, 8, "lado");
		mapa.includeWall(6, 8, "lado");
		mapa.includeWall(7, 8, "lado");
		...
		int[][] posicoesocupadas= new int[19][26]; 
		for(int i=0; i<19; i++) {
			for(int j=0; j<26; j++) {
		...
		//cria Baus
		int numeroBaus = rand.nextInt(12);
		
		for(int i=0; i< numeroBaus; i++) {
			randX = rand.nextInt(26);
			randY = rand.nextInt(19);
			if(posicoesocupadas[randY][randX] == 1) {
				i--;
			}
			else {
				posicoesocupadas[randY][randX] = 1;
				mapa.includeBau(randX, randY);
			}
		}
		...
		//cria Armadilhas
		int numeroArmadilhas = rand.nextInt(12);
		
		for(int i=0; i< numeroArmadilhas; i++) {
			randX = rand.nextInt(26);
			randY = rand.nextInt(19);
			if(posicoesocupadas[randY][randX] == 1) {
				i--;
				...
				posicoesocupadas[randY][randX] = 1;
				mapa.includeArmadilha(randX, randY);
			}
		}
		...
		//cria Monstros
		int numeroMonstros = rand.nextInt(24);
		
		for(int i=0; i< numeroMonstros; i++) {
			randX = rand.nextInt(26);
			randY = rand.nextInt(19);
			if(posicoesocupadas[randY][randX] == 1) {
				i--;
				...
				posicoesocupadas[randY][randX] = 1;
				int monstercode = rand.nextInt(3);
				
				if(monstercode == 0) {
					mapa.includeGoblin(randX,randY);
				}
				else if(monstercode == 1) {
					mapa.includeEsqueleto(randX,randY);
				}
				else{
